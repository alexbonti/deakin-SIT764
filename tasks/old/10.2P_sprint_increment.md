...
## Team Pass Task 10.2: Week 10 Sprint 4 Increment
...
This is a **team** submission, and your **final** Sprint Increment. Update the Increment Report accordingly to reflect this. Submit only one Sprint Increment at the end of **each** Sprint.
...
2. Produce your supporting artefacts. Given that this is your last Sprint, you will need to produce handover documentation (if applicable) in addition to the Sprint Increment Report as the **minimum supporting artefacts**.
...
* a screen cast video with audio commentary to teach new users how to use the deliverable(s) produced
